...
import com.SearchMicroservice.Entities.Flight;import com.SearchMicroservice.Entities.Seat;
...
public class FlightController {
    ...
    @GetMapping("/seats/status/{flightId}/{flightDate}/{seatNumber}")
    ...
    public ResponseEntity<List<Flight>> searchFlights(
        ...
        List<Flight> flights = flightService.searchFlights(origin, destination, flightDate, seatClass);
        return ResponseEntity.ok(flights);
    }
    @GetMapping("/price/id/{seatId}")
    public double getSeatPriceById(@PathVariable Long seatId) {
        return seatService.getSeatPriceById(seatId);
    }

    @GetMapping("/price/number/{seatNumber}")
    public double getSeatPriceByNumber(@PathVariable String seatNumber) {
        return seatService.getSeatPriceByNumber(seatNumber);
    }
    
    @GetMapping("/price-by-class/{seatClass}")
    public ResponseEntity<Double> getSeatPriceByClass(@PathVariable String seatClass) {
        Double price = seatService.getSeatPriceByClass(seatClass);
